...
patterns: [
  ...
  function getGeneralEducationTableMetadata() {
    return [...document.querySelectorAll("table.datagrid")].map((table) => {
  ...
  function initializeGeneralEducationCourseFilter() {
    const initialize = () => {
      ...
      const categories = tables.flatMap(
