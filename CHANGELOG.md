...
> 在选课网课程列表加入通识课类别筛选，支持通识课、一至四系列与未区分分类；筛选仅在本地隐藏当前页课程。
...
> 增加选课网的点击 Logo 返回帮助页面的功能。

**2026.01.22 - v2.6.22**

> 优化 electiveWork 页面样式与应用页面匹配规则。

**2026.01.22 - v2.6.21**

> 支持预选界面，重构函数命名，复用部分选课网页面重构代码。
...
> Merged #28，thx @dfshfghj，恢复了课程间跳转功能。
...
> 优化细节，对于 Safari+UserScripts 现也支持日夜模式穿透。

**2025.11.29 - v2.6.14**

> 优化下载区域样式，增加取消/重新下载按钮。
...
> 调整一下刷新的间隔时间，确保能够截获课程数据。

**2025.11.06 - v2.6.8**

> 现在在打开妙妙小工具时，会尝试复制 JWT 到剪贴板，方便使用。

**2025.11.05 - v2.6.7**

> 修改了系统主题按钮的 hover 颜色，原先不太好看，不爽，遂换之。

**2025.11.05 - v2.6.6**

> 修复前一个版本新增功能的加载时机 Bug。
